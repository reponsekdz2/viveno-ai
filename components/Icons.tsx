...
export const FilmIcon: React.FC<{className?: string}> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75h3m-3.75-3.75h3.75m-7.5-3.75h7.5m-7.5-3.75h7.5m3-3.75H3.75c-1.125 0-2.25.9-2.25 2.25v11.25c0 1.242 1.008 2.25 2.25 2.25h16.5c1.242 0 2.25-1.008 2.25-2.25V6.75c0-1.242-1.008-2.25-2.25-2.25H3.75z" />
  </svg>
);
...
export const RectangleStackIcon: React.FC<{className?: string}> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21.75l-9.75-5.25L6.429 15m11.142 0l4.179-2.25L12 21.75l-4.179-2.25m0 0l5.571 3 5.571-3" />
  </svg>
);
...
export const Cog6ToothIcon: React.FC<{className?: string}> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.962a8.977 8.977 0 015.7 4.042 1.125 1.125 0 01-1.583 1.582 6.736 6.736 0 00-3.363-3.363c-.48-.2-.97-.45-1.488-.696a1.125 1.125 0 01.696-2.115V3.75c0-.621-.504-1.125-1.125-1.125H10.5z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.066 18.6c.09.542.56 1.007 1.11.962a8.977 8.977 0 005.7-4.042 1.125 1.125 0 00-1.583-1.582 6.736 6.736 0 01-3.363 3.363c-.48.2-.97.45-1.488.696a1.125 1.125 0 00.696 2.115v.25c0 .621-.504 1.125-1.125 1.125h-1.503z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.94 14.066c-.09.542-.56 1.007-1.11.962a8.977 8.977 0 01-5.7-4.042A1.125 1.125 0 013.11 9.4a6.736 6.736 0 003.363 3.363c.48.2.97.45 1.488.696a1.125 1.125 0 01-.696 2.115v.25c0 .621.504 1.125 1.125 1.125h1.503z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.6 9.934c-.09-.542-.56-1.007-1.11-.962a8.977 8.977 0 00-5.7-4.042A1.125 1.125 0 009.4 6.49a6.736 6.736 0 013.363 3.363c.48.2.97.45 1.488.696a1.125 1.125 0 00.696-2.115V8.25c0-.621.504-1.125 1.125-1.125h1.503z" />
  </svg>
);
...
export const LanguageIcon: React.FC<{className?: string}> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21l5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 016-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C13.18 7.76 14.16 9 15.333 9h2.333M3 21h6v-3.75M21 3.75l-6 17.25" />
    </svg>
);

export const FrameIcon: React.FC<{className?: string}> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 4.5v15m6-15v15m-10.5-6H21m-21-6h21" />
    </svg>
);

export const MusicalNoteIcon: React.FC<{className?: string}> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-.99-3.467l2.31-.66a2.25 2.25 0 001.632-2.163zm0 0V7.5A2.25 2.25 0 0013.5 6h-3a2.25 2.25 0 00-2.25 2.25v1.5M12 12.75a2.25 2.25 0 00-2.25 2.25v3.75a2.25 2.25 0 002.25 2.25h3a2.25 2.25 0 002.25-2.25v-3.75a2.25 2.25 0 00-2.25-2.25h-3z" />
  </svg>
);
...
export const UploadCloudIcon: React.FC<{className?: string}> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75m-7.5-3a9 9 0 1115 0 9 9 0 01-15 0z" />
  </svg>
);
...
export const ArrowsPointingOutIcon: React.FC<{className?: string}> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75v4.5m0-4.5h-4.5m4.5 0L15 9m5.25 11.25v-4.5m0 4.5h-4.5m4.5 0L15 15" />
    </svg>
);

export const ArrowPathRoundedSquareIcon: React.FC<{className?: string}> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.185m-3.181 9.995l-3.182-3.182a8.25 8.25 0 010-11.664l3.181-3.182" />
    </svg>
);
...
export const CrownIcon: React.FC<{className?: string}> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6.375l3 3m0 0l-3 3m3-3h-6m-1.875-3L5.625 9m1.875-3L9.375 3m0 0L5.625 9m3.75 9.375l3-3m0 0l-3-3m3 3h-6m-1.875 3L5.625 15m1.875 3L9.375 21m0 0L5.625 15" />
    </svg>
);

export const CubeTransparentIcon: React.FC<{className?: string}> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
